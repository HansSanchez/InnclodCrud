            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="{{ asset('assets/blk/img/Web/6310507.jpg') }}" alt="sing up image"></figure>
                    ...
                    <div class="signin-form div-center">
                        <div class="div-center">
                            <div class="div-size-custom">
                                ...
                                <h2 class="text-center form-title text-register SoberanaSans-Regular">Inicio de sesión
                                </h2>
